...
- `example/ck_tile/01_fmha/script/smoke_test_fwd_sink.sh`  (+86/-0)
- `include/ck_tile/ops/fmha/pipeline/block_fmha_fwd_splitkv_pipeline_nwarp_sshuffle_qr_ks_vs.hpp`  (+65/-21)
- `example/ck_tile/01_fmha/script/correct_test_fwd_sink.sh`  (+77/-0)
- `example/ck_tile/01_fmha/codegen/ops/fmha_fwd.py`  (+45/-30)
...
- `example/ck_tile/01_fmha/fmha_fwd.hpp`  (+23/-2)
- `include/ck_tile/ops/fmha/kernel/fmha_fwd_kernel.hpp`  (+16/-1)
...
{F_skip},
{F_sink}>;
{F_pipeline_enum}, {F_logits}, fmha_mask, {F_bias}, {F_lse}, {F_dropout}, {F_qscale}, {F_spad}, {F_skpad}, {F_dpad}, {F_
