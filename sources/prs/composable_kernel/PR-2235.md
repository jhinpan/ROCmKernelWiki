---
id: pr-composable_kernel-2235
repo: ROCm/composable_kernel
pr: 2235
title: Revert 'Remove not needed bwd wei merged groups instances (#2218)'
author: bartekxk
date: '2025-05-26'
url: https://github.com/ROCm/composable_kernel/pull/2235
...
# Revert 'Remove not needed bwd wei merged groups instances (#2218)'

**Repository:** [ROCm/composable_kernel](https://github.com/ROCm/composable_kernel) · **PR:** [#2235](https://github.com/ROCm/composable_kernel/pull/2235) · **Merged:** 2025-05-26 · **Author:** @bartekxk

**Inclusion reason:** kernel path 'library/include/ck/library/tensor_operation_instance/gpu/grouped_convolution_forward_wmma.inc'; keyword 'wmma'

## Summary (from upstream PR description)

This reverts commit 4583aef.
Proposed changes
