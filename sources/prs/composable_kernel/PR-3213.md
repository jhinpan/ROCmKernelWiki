---
id: pr-composable_kernel-3213
repo: ROCm/composable_kernel
pr: 3213
title: Add new gemm multiply multiply instances on gfx950
author: jefyang1
date: '2025-11-14'
url: https://github.com/ROCm/composable_kernel/pull/3213
...
- kernel-grouped-gemm
---
# Add new gemm multiply multiply instances on gfx950

**Repository:** [ROCm/composable_kernel](https://github.com/ROCm/composable_kernel) · **PR:** [#3213](https://github.com/ROCm/composable_kernel/pull/3213) · **Merged:** 2025-11-14 · **Author:** @jefyang1
...
Proposed changes
Add new gemm multiply multiply instances for gfx950, which have better performance for some tested shapes. Also align D0 integer initialization range the same as gemm multiply multiply Bpreshuffle operator.
Checklist
