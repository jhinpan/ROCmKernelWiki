---
id: pr-composable_kernel-2758
repo: ROCm/composable_kernel
pr: 2758
title: 'chore(gemm): clang format to pass CI'
author: AviralGoelAMD
date: '2025-08-29'
url: https://github.com/ROCm/composable_kernel/pull/2758
...
status: merged
merge_sha: fcff0043ae35
inclusion_reason: kernel path 'example/ck_tile/38_block_scale_gemm/gemm_bquant_basic.cpp';
  keyword 'gemm'
changed_paths:
...
# chore(gemm): clang format to pass CI

**Repository:** [ROCm/composable_kernel](https://github.com/ROCm/composable_kernel) · **PR:** [#2758](https://github.com/ROCm/composable_kernel/pull/2758) · **Merged:** 2025-08-29 · **Author:** @AviralGoelAMD

**Inclusion reason:** kernel path 'example/ck_tile/38_block_scale_gemm/gemm_bquant_basic.cpp'; keyword 'gemm'
